...
class TranslationHandler(BaseNodeHandler):
    def __init__(self, redis_service):
        ...
        logger.info("Initializing modular Translation Handler")
    ...
    async def execute(self, message: NodeExecutionMessage) -> Dict[str, Any]:
        ...
        try:
            ...
            if not text.strip(): raise ValueError("No text provided for translation")
            ...
            translated_text = await loop.run_in_executor(None, _call_llm)

            output = {**context, "original_text": text, "translated_text": translated_text, "source_language": source_language, "target_language": target_language, "node_type": "translation", "node_executed_at": datetime.now().isoformat()}
