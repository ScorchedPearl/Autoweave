...
const Footer = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
      <div className="md:col-span-2">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-2xl font-bold">AutoWeave</h3>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          <span className="px-3 py-1 bg-secondary rounded-full text-sm border border-border">Real-Time</span>
          <span className="px-3 py-1 bg-secondary rounded-full text-sm border border-border">Enterprise Ready</span>
          <span className="px-3 py-1 bg-secondary rounded-full text-sm border border-border">99.9% Uptime</span>
        </div>
      </div>
      <div>
    ...
    <div className="border-t border-border pt-8 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-6 text-muted-foreground">
        <p>&copy; {currentYear} AutoWeave. All rights reserved.</p>
        ...
        <p  className="hover:text-cyan-500 transition-colors">Terms of Service</p>
        </Link>
      </div>
