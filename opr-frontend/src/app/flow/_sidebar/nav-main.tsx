    ...
    <div className="space-y-1">
      <div className="px-3 py-2">
              ...
              <div>
                <CollapsibleTrigger asChild>
                  ...
                  >
                    {item.icon && (
                      <item.icon
                        className={`mr-2 h-4 w-4 ${item.isActive ? "text-cyan-400" : ""
                          }`}
                      />
                    )}
                        ...
                        >
                          ...
                          >
                            ...
                            {subItem.badge && (
                              <Badge
                                variant="secondary"
                                className="ml-auto text-xs bg-cyan-400/20 text-cyan-400 border border-cyan-400/30"
                              >
                                {subItem.badge}
                              </Badge>
                            )}
        ...
        <div className="mt-4 px-4">
          ...
          <div className="mt-2 text-[10px] text-white/30">v1.0.0</div>
        </div>
